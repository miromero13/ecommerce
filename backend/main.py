...
from app.routes import user_routes, auth, branch_routes, provider_routes, catalog_routes, inventory_routes, cart_routes, reservation_routes, order_routes, payment_routes, sales_routes, report_routes, dashboard_routes, promotion_routes, replenishment_routes
