...
class OrderItem(Base):
    ...
    reservation_id = Column(UUID(as_uuid=True), ForeignKey("reservations.id"), nullable=True, index=True)
    ...
    __table_args__ = (UniqueConstraint("order_id", "variant_id", name="uq_order_item_order_variant"),)
